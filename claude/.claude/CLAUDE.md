> **Note to human:** This file provides project-agnostic principles and standards for Claude Code (claude.ai/code) across all repositories.

## Core Principles

### Chatting with me

- Always use Solarized colors when showing colored output
...
- **Testing**: I will explictly tell you when to write tests
